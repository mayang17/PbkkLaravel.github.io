...
<head>
  ...
  <meta charset="utf-8">
    ...
    <title>Barbershop Bengkulu</title>
    <style>
        .text-logo {
            font-family: 'Courier New', Courier, monospace; /* Choose an aesthetic font */
            font-size: 5rem; /* Make the text larger */
            font-weight: bold; /* Make the text bold */
            color: #4A90E2; /* Set a cool color for the text */
            text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3); /* Add a shadow for depth */
            transition: color 0.3s ease; /* Add a transition effect */
        }

        .text-logo:hover {
            color: #EA5B25; /* Change color on hover */
        }
    </style>
      ...
      <div class="container-lg">
        <div class="row justify-content-evenly">
          ...
          <div class="col d-none d-md-block">
            <p class="text-center text-black m-0"><strong>Special Offer</strong>: "Gaya yang Membuat Anda Percaya Diri!"
            </p>
          </div>
          <div class="col">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              ...
              <li class="nav-item">
                <a class="nav-link me-5" href="#">Kids</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link me-5 active dropdown-toggle border-0" href="#" data-bs-toggle="dropdown"
        ...
        <div class="col-lg-2 pb-3">
          <div class="footer-menu">
            ...
            <div class="footer-contact-text">
              <span>Babershop Bengkulu </span>
              <span> Call us: (+33) 800 456 789-987 </span>
              <span class="text-hover fw-bold light-border"><a href="mailto:Julia@.com">contact@yourwebsite.com</a></span>
            </div>
          </div>
        </div>
      </div>
